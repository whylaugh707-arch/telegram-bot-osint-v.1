    ...
    <div className="flex flex-col h-full bg-slate-950 text-[#38bdf8]">
      <div className="p-6 border-b border-[#38bdf8]/20 bg-[#38bdf8]/5">
        <h2 className="text-xl font-bold flex items-center mb-2 tracking-tighter">
          <Globe className="w-5 h-5 mr-3 text-[#38bdf8]" /> DOMAIN_INTEL
        </h2>
        <p className="text-xs text-[#38bdf8]/60 uppercase tracking-widest">Cross-grid DNS lookup and WHOIS domain registration auditing.</p>
      </div>
      ...
      <div className="p-6 overflow-y-auto">
        <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 mb-8">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className="px-4 py-2.5 border border-[#38bdf8]/20 hover:bg-[#38bdf8]/10 text-[#38bdf8] font-bold text-xs uppercase tracking-tighter disabled:opacity-30 transition-all active:scale-95"
            >
        ...
        <div className="mt-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex space-x-8 border-b border-[#38bdf8]/10 mb-6">
            <button 
              className={`pb-2 text-[10px] font-bold tracking-[0.2em] uppercase transition-all ${activeTab === 'whois' ? 'text-[#38bdf8] border-b border-[#38bdf8]' : 'text-[#38bdf8]/40 hover:text-[#38bdf8]'}`}
              onClick={() => setActiveTab('whois')}
            >WHOIS_MANIFEST</button>
            <button 
              className={`pb-2 text-[10px] font-bold tracking-[0.2em] uppercase transition-all ${activeTab === 'dns' ? 'text-[#38bdf8] border-b border-[#38bdf8]' : 'text-[#38bdf8]/40 hover:text-[#38bdf8]'}`}
          ...
          <div className="relative">
            {activeTab === 'whois' && whoisResult && (
              <div className="bg-slate-950/50 rounded border border-[#38bdf8]/20 p-6 max-h-[450px] overflow-y-auto font-display text-xs text-[#38bdf8]/80 whitespace-pre-wrap leading-relaxed shadow-[inset_0_0_20px_rgba(0,255,0,0.05)]">
                {whoisResult}
              </div>
            )}
            ...
            {activeTab === 'whois' && !whoisResult && !loadingWhois && (
               <div className="text-center py-20 text-[#38bdf8]/20 text-[10px] uppercase tracking-[0.3em] flex flex-col items-center">
